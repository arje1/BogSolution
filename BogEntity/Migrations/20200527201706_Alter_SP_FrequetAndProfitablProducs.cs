...
{
    public partial class Alter_SP_FrequetAndProfitablProducs : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string SqlScript =
            @"ALTER PROC [Analytics].[spGetSales_BasedOnFrequentAndProfitableProductsByConsultants]
(
@StartDate DATE = NULL,
@EndDate DATE = NULL
)
...
ISNULL(SUM(PS_Profitable.PricePerUnit * PS_Profitable.PricePerUnit), 0) AS ProfitableProductRevenue
