...
namespace BogEntity.Migrations
{
    ...
    [Migration("20200527194417_Add_SP_spGetSals_BasedOnFrequentAndProfitableProductsByConsultnts")]
    partial class Add_SP_spGetSals_BasedOnFrequentAndProfitableProductsByConsultnts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BogEntity.Entities.StoredProcedureEntities.spGetSales_BasedOnConsultants", b =>
                {
                    ...
                    b.Property<string>("ConsultantPrivateNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("OperationDate")
                        .HasColumnType("datetime2");

                    b.Property<double>("ProductPriceSum")
                        .HasColumnType("float");

                    b.Property<int>("ProductUnitSum")
                        .HasColumnType("int");

                    b.Property<string>("SaleCode")
                        .HasColumnType("nvarchar(max)");

                    b.ToTable("spGetSales_BasedOnConsultants");
                });

            modelBuilder.Entity("BogEntity.Entities.StoredProcedureEntities.spGetSales_BasedOnFrequentProductsByConsultants", b =>
                {
                    b.Property<DateTime>("ConsultantBirthDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("spGetSales_BasedOnFrequentProductsByConsultants");
                });

            modelBuilder.Entity("BogEntity.Entities.StoredProcedureEntities.spGetSales_BasedOnProductPriceRange", b =>
                {
                    b.Property<string>("ConsultantCode")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("spGetSales_BasedOnProductPriceRanges");
                });

            modelBuilder.Entity("BogEntity.Entities.StoredProcedureEntities.spGetSales_BasedOnSalesSumByConsultants", b =>
                {
                    b.Property<DateTime>("ConsultantBirthDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("SalesQuantityIncludingSubConsultants")
                        .HasColumnType("int");

                    b.ToTable("spGetSales_BasedOnSalesSumByConsultants");
                });
